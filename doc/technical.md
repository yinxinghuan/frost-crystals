...
- 游戏：Frost Crystals
- 类型：casual
- 简述：Touch the cold glass and a six-fold snowflake grows from your finger — drag to steer the branches, hold to let it bloom. Multiple flakes coexist; a slow thaw clears the glass. AlterU sensory toy.
- 框架 / 语言 / 构建：JavaScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Frost Crystals；cover_url=/poster.png；category=casual；uuid=881877de-da56-4f0c-b3bb-70046e5daf70
